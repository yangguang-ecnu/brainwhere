...
if [ $generateClusterReport -eq 1 ]; then
	for blind in ${blindList}; do
		for session in 3mo; do
			...
			#  -m /home/stowler/toScreen-r01clusterReports/${blind}_${session}_clust.16thresh.50ul_maskBW.nii.gz \
			#  -o /home/stowler/toScreen-r01clusterReports/${blind}_${session}_clust.16thresh.50ul_reportBW.txt \
